...
if(!empty($_POST)){
    ...
    if(!empty($name) && !empty($gia)){
        $sqli = 'INSERT INTO sanpham VALUES (NULL,"'.$name.'",'.$gia.',"'.$hinhanh.'","'.$kichthuoc.'","'.$chieucaoyen.'","'.$kichthuocbanh.'","'.$dongco.'","'.$cc.'","'.$congsuat.'","'.$ccnhot.'","'.$ccxang.'","'.$phanh.'","'.$hopso.'","'.$tenhang.'")';
    execute($sqli);
                    ...
                    <div class="sb-sidenav-menu">
                         <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                ...
                                <?php
                                        // lấy dữ liệu hãng ra
                                        $sqli = 'select * from hang';   
                                        $categoryList = executeResult($sqli);
                                        $index = 1;
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4"> MORE PRODUCTS</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="admin.php"> CATEGORY </a></li>
                            <li class="breadcrumb-item active"> More products </li>
                        </ol>
                                ...
                                <form method="post">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="small mb-1" for="id_category"> THE FIRM </label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1"> ProductName </label>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; MOWO - MOTO WORLD 2023</div>
                        </div>
                    </div>
                </footer>
            </div>
