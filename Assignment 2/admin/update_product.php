            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4"> Monify Product</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="admin.php"> CATEGORY </a></li>
                            <li class="breadcrumb-item active"> Monify Product </li>
                        </ol>
                            ...
                            <div class="card-body">
                                ...
                                <form method="post">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="id_category"> Vehicles </label>
                                            ...
                                            <div class="form-group mt-4 mb-0">
                                                <button class="btn btn-primary btn-block"> Monify </button>
                                            </div>
                                </form> ';}?> 
                            </div>
                        </div>     
