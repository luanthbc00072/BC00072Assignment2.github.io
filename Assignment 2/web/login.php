...
if(!empty($_POST))
{
    ...
    if(!empty($username) && !empty($password))
    {
        ...
        $sqli = 'select * from taikhoan where username = "'.$username.'" and password = "'.$password.'" ';
	$query = mysqli_query($con,$sqli);
	$num_rows = mysqli_num_rows($query);
	if ($num_rows==0) 
        {
            header('Location: login.php');
            $_SESSION['dangnhap'] = 'Enter the wrong password!';
        }else{
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" onsubmit = "return dangnhap()">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">   
                                                <input class="btn btn-primary" type="submit" value="Summit">
