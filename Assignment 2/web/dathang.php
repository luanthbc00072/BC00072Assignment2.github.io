...
if(!empty($_POST)){
    ...
    if(!empty($hovaten) && !empty($sdt) && !empty($email) && !empty($diachi)){
        $sqli = 'INSERT INTO donhang VALUES (NULL,"'.$tensp.'",'.$soluong.',"'.$hovaten.'","'.$sdt.'","'.$email.'","'.$diachi.'","'.$ghichu.'")';
    execute($sqli);
                                        ...
                                        <form method="post" onsubmit="return dathang()">
                                            <div class="form-row">
                                               ...
                                               <div class="col-md-6">
                                                    ...
                                                    echo '<h6>Unit price:&emsp;&emsp;  '.$gia.'$ </h6>'; 
                                                    echo '<h6>Quantity: &emsp;  '.$soluong.' </h6>'; 
                                                    echo '<h6>Total:&emsp;&nbsp; '.$tongtien.'$ </h6>'; 
                                                    ?> 
                                                    </div>
                                               </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFirstName">First and last name</label>
                                            ...
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">Address *(Please specify HOUSE NUMBER, WARD/COMMEND, DISTRICT/DISTRICT, PROVINCE/CITY)</label>
                                                <input class="form-control py-4" id="diachi" name="diachi" type="text" aria-describedby="emailHelp"/>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress"> Note </label>
