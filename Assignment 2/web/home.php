        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5> Car price December </h5>
                <p class="card-text">
                Latest Honda car prices at Vietnamese dealers
                </p> 
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5> Car price December </h5>
                <p class="card-text">
                Latest SUZUKI car prices at Vietnamese dealers
                </p> 
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5> Car price December </h5>
                <p class="card-text">
                Latest YAMAHA car prices at Vietnamese dealers
                </p> 
              </div>
